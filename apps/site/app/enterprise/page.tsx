...
const COPY = {
  en: {
    ...
    submittedBody:
      "Our team will contact you within 12 hours to discuss dedicated capacity.",
    name: "Name",
    company: "Company",
    email: "Work Email",
    ...
    latency: "Target video speed",
    latencyPh: "e.g. under 60s per video",
