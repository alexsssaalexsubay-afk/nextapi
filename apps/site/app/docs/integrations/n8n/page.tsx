  ...
  "jsonBody": {
    ...
    "resolution": "1080p"
        ...
        steps={[
          ...
          "Set the method to POST and the URL to https://api.nextapi.top/v1/video/generations.",
          "Configure the authentication to use your Header Auth credential with header name \"Authorization\" and value \"Bearer {key}\".",
          "Set the JSON body with your model, prompt, duration_seconds, and resolution parameters.",
