...
plans with full Seedance 2.0 and ComfyUI integration.

Every agent step is fully configurable: choose between API LLMs
(OpenAI, Anthropic, Google, etc.) or local models via Ollama.
"""
