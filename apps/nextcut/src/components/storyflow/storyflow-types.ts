  ...
  const nodes: StoryflowNode[] = [
    ...
    },
    {
      ...
      data: {
        ...
        metric: "结构化",
        tags: [structuredPrompt.lighting || "灯光", structuredPrompt.audio || "声音提示"],
      },
    ...
    },
    {
      ...
      data: {
        ...
        metric: `${Math.max(references.length, 3)} 份参考`,
    ...
    ...shots.map((shot, index) => ({
      ...
      data: {
        kind: "shot" as const,
        eyebrow: `镜头 ${String(index + 1).padStart(2, "0")}`,
        title: shot.title,
        ...
        tags: [shot.status || "已规划", shot.camera?.split(",")[0] || "运镜"],
      },
    ...
    },
    {
      ...
      data: {
        ...
        eyebrow: "版本节点",
        title: "版本快照",
        description: "保存当前流程画布，便于对比、回滚和交付前确认。",
        metric: "v1",
        tags: ["快照", "回滚"],
      },
