...
export const DIRECTOR_KNOWLEDGE_SOURCES: DirectorKnowledgeSource[] = [
  {
    ...
    name: "Massive Prompt Dict",
    scope: "SQLite RAG prompt/tag dictionary",
    status: "sidecar",
    metric: "50,830 prompts / 501,586 tags",
  ...
  },
  {
    ...
    scope: "Hunyuan / Seedance / LTX hard rules",
    status: "sidecar",
    metric: "5 full examples + hard rules",
  ...
  },
  {
    id: "camera_presets",
    name: "Camera Presets",
    scope: "Professional cinematography templates",
    status: "sidecar",
    metric: "10 camera templates",
  ...
  },
  {
    ...
    scope: "Shot generation contract",
    status: "sidecar",
    metric: "style / format / reference policy",
  ...
  },
  {
    ...
    scope: "7-axis video model routing",
    status: "sidecar",
    metric: "5 provider profiles",
  ...
  },
  {
    id: "vimax_bridge",
    name: "ViMax Director",
    scope: "Vendored multi-agent video pipeline",
    status: "vendored",
    metric: "script / storyboard / reference / consistency",
    value: "一句话到故事、脚本、角色、分镜、参考图选择和一致性校验",
    rules: ["保持角色和场景连续", "同机位镜头可并行生成提高效率"],
  },
  {
    id: "short_drama_pack",
    name: "Short Drama Pack",
    scope: "Drama and ecommerce templates",
    status: "local",
    metric: "10 templates + sample manifest",
  ...
  },
  {
    ...
    scope: "Frontend camera/lens/light/style dictionary",
    status: "frontend",
    metric: "camera / lens / lighting / image presets",
    value: "UI 侧可即时使用的镜头、光学、灯光、分镜图词库",
    rules: ["把选择器和生成 prompt 直接联动", "所有标签最终落到镜头卡片"],
  },
];
