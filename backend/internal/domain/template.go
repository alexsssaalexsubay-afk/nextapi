...
type Template struct {
	...
	WorkflowJSON           json.RawMessage `gorm:"type:jsonb;column:workflow_json"`
	RecommendedInputSchema json.RawMessage `gorm:"type:jsonb;column:recommended_inputs_schema;not null;default:'[]'"`
	...
	PreviewVideoURL        *string         `gorm:"column:preview_video_url"`
	EstimatedCostCents     *int64          `gorm:"column:estimated_cost_cents"`
